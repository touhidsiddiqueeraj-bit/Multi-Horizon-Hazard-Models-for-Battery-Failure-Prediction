...
\item a shortcut diagnosis of cross-dataset, cross-chemistry transfer: minimal baselines (a distance-to-threshold rule, SOH-only, cycle-only, and sensor-only logistic regressions), a factorial feature ablation over \{SOH, cycle index, sensors\}, a failure-definition ablation that relabels failures by SOH or by voltage sag alone, and same-chemistry cross-laboratory controls (NASA$\leftrightarrow$\allowbreak{}CALCE and Severson$\to$\allowbreak{}Oxford) that separate dataset shift from chemistry shift;
...
\item \textbf{Same-chemistry, cross-laboratory controls}: NASA$\to$\allowbreak{}CALCE and CALCE$\to$\allowbreak{}NASA (LCO$\to$LCO) and Severson$\to$\allowbreak{}Oxford and Oxford$\to$Severson (LFP$\to$LFP). Because chemistry, laboratory, cell manufacturer, cycling protocol, temperature, and logging resolution all change simultaneously between any source and target, the cross-chemistry shifts above are cross-\emph{dataset} shifts as well; ``cross-chemistry'' is used throughout as shorthand, and these controls are what allow dataset shift and chemistry shift to be told apart;
...
\midrule
NASA$\to$\allowbreak{}CALCE (LCO$\to$LCO) & 0.870 [0.799,0.966] & 0.849 [0.753,0.985] & 0.781 [0.708,0.964] \\
CALCE$\to$\allowbreak{}NASA (LCO$\to$LCO) & 0.543 [0.356,0.677] & 0.566 [0.427,0.678] & 0.601 [0.496,0.703] \\
Severson$\to$\allowbreak{}Oxford (LFP$\to$LFP) & 0.997 [0.991,1.000] & 0.471 [0.466,0.477] & 0.428 [0.422,0.435] \\
