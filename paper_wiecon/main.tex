...
\begin{figure}[!t]
\centering
\includegraphics[width=0.72\columnwidth]{figs/fig_framework.png}
...
upper bounds that include this label-proximity leakage;
Section~III-E quantifies it by relabeling failure with a single
endpoint at a time.
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.82\columnwidth]{figs/fig_within_horizons.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.9\columnwidth]{figs/fig_reliability_v2.png}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.94\columnwidth]{figs/fig_collapse_map.png}
