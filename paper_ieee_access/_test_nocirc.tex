...
\begin{figure}[!t]
\centering
\includegraphics[width=\columnwidth]{fig_deploy.png}
...
\begin{table}[t]
\caption{DeLong Test $p$-Values for the SOH Ablation (ALL-LCO $\to$ LFP, H=20). AUCs Are Pooled Across Test Cells (See Table III for Per-Cell Means). All Comparisons Are Significant at $\alpha=0.05$.}
\label{tab:delong}
\centering
